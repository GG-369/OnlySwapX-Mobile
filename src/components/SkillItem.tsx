...
import { categoryLabel, formatDistance, levelLabel } from '@/utils/format';
    ...
    <TouchableOpacity activeOpacity={onPress ? 0.85 : 1} onPress={onPress}>
      <Card style={styles.card}>
        ...
        <View style={styles.metaRow}>
          {skill.category ? <Badge>{categoryLabel(skill.category)}</Badge> : null}
          {skill.level ? <Badge tone="blue">{levelLabel(skill.level)}</Badge> : null}
        </View>
