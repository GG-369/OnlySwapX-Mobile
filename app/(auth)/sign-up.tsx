...
export default function SignUpScreen() {
  ...
  const handleSignUp = async () => {
    if (!fullName.trim() || !email.trim() || password.length < 6) {
      Alert.alert('Incomplete data', 'Fill in your name, email, and a password of at least 6 characters.');
      return;
    }
    ...
    <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={styles.screen}>
      <ScrollView contentContainerStyle={styles.container} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.form}>
          ...
          <TextInput style={styles.input} placeholder="At least 6 characters" placeholderTextColor="#64748b" value={password} autoCapitalize="none" secureTextEntry onChangeText={setPassword} />
